...
from co_datasets.vrp_dataset import VRPGraphDataset
...
class VRPModel(COMetaModel):
  ...
  def forward(self, x, adj, t, edge_index, problem_size=None):
    return self.model(x, t, adj, edge_index, problem_size)

  def categorical_training_step(self, batch, batch_idx):
    edge_index = None
    _, depot, points, adj_matrix, _ = batch
  ...
  def categorical_denoise_step(self, points, xt, t, device, edge_index=None, target_t=None, problem_size=None):
    with torch.no_grad():
